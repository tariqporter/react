      ...
      a: {
        ...
        switch (current$$1.tag) {
          ...
          case 19:
            ...
            current$$1 = current$$1.stateNode;
            current$$1.props = textNode;
            current$$1.rootInstance = renderExpirationTime;
            null === current$$1.state &&
              void 0 !== rootContainerInstance.createInitialState &&
              (current$$1.state = rootContainerInstance.createInitialState(
                textNode
              ));
...
function commitRootImpl(root, expirationTime) {
  ...
  if (null !== updateExpirationTimeBeforeCommit) {
    ...
    do
      try {
        for (effectTag = expirationTime; null !== nextEffect$1; ) {
  ...
  if (rootDoesHavePassiveEffects)
    (rootDoesHavePassiveEffects = !1), (rootWithPendingPassiveEffects$1 = root);
  else
    for (
      nextEffect$1 = updateExpirationTimeBeforeCommit;
      null !== nextEffect$1;
      ...
      (expirationTime = nextEffect$1.nextEffect),
        (nextEffect$1.nextEffect = null),
        (nextEffect$1 = expirationTime);
  expirationTime = root.firstPendingTime;
  0 !== expirationTime
