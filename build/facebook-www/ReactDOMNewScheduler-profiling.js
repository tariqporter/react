...
function completeWork(current, workInProgress, renderExpirationTime) {
  ...
  switch (workInProgress.tag) {
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode)
        ...
        if (popHydrationState(workInProgress)) {
          ...
          null !== newProps && markUpdate(workInProgress);
        } else {
          propKey =
    ...
    case 18:
      if (null === current) {
        ...
        a: {
          ...
          for (newProps = 0; workInProgress; ) {
            if (8 === workInProgress.nodeType)
              if (
                ((renderExpirationTime = workInProgress.data),
                "/$" === renderExpirationTime)
              ) {
                if (0 === newProps) {
                ...
                newProps--;
              } else "$" === renderExpirationTime && newProps++;
            workInProgress = workInProgress.nextSibling;
          }
          nextHydratableInstance = null;
        }
    ...
    case 19:
      ...
      workInProgress.rootInstance = renderExpirationTime;
      null === workInProgress.state &&
        void 0 !== type.createInitialState &&
        (workInProgress.state = type.createInitialState(newProps));
...
function commitRootImpl(root, expirationTime) {
  ...
  if (null !== updateExpirationTimeBeforeCommit) {
    childExpirationTimeBeforeCommit = workPhase;
    workPhase = 5;
    var prevInteractions = tracing.__interactionsRef.current;
    ...
    _enabled = !1;
    nextEffect$1 = updateExpirationTimeBeforeCommit;
    do
      try {
    ...
    nextEffect$1 = null;
    tracing.__interactionsRef.current = prevInteractions;
    workPhase = childExpirationTimeBeforeCommit;
  } else
    (root.current = finishedWork),
      startCommitSnapshotEffectsTimer(),
      stopCommitSnapshotEffectsTimer(),
  ...
  if (rootDoesHavePassiveEffects)
    ...
    for (
      ...
      (effectTag$jscomp$0 = nextEffect$1.nextEffect),
        (nextEffect$1.nextEffect = null),
        (nextEffect$1 = effectTag$jscomp$0);
