...
function commitPassiveEffects(root, firstEffect) {
  ...
  do {
    ...
    didError = firstEffect.nextEffect;
    firstEffect.nextEffect = null;
    firstEffect = didError;
      ...
      a: {
        ...
        switch (current$$1.tag) {
          ...
          case 19:
            ...
            (siblingFiber = current$$1.type.responder),
            (workInProgress = current$$1.stateNode),
            (workInProgress.props = newProps),
            (workInProgress.rootInstance = returnFiber),
            null === workInProgress.state &&
              void 0 !== siblingFiber.createInitialState &&
              (workInProgress.state = siblingFiber.createInitialState(
                newProps
              )),
...
function completeRoot(root, finishedWork$jscomp$0, expirationTime) {
  ...
  if (null !== firstBatch && null !== rootWithPendingPassiveEffects)
