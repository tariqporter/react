            ...
            a: for (snapshot = instance = prevState; ; ) {
              b: {
                ...
                switch (childExpirationTimeBeforeCommit.tag) {
                  ...
                  case 15:
                    var updateQueue =
                      childExpirationTimeBeforeCommit.updateQueue;
                    if (null !== updateQueue) {
                ...
                childExpirationTimeBeforeCommit.stateNode = null;
                null != childExpirationTimeBeforeCommit.alternate &&
                  (childExpirationTimeBeforeCommit.alternate.stateNode = null);
              }
